            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class= "nav-link" href="<?php echo e(route('auth.login')); ?>">Log in</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="container_login">
                                    ...
                                    <form action="<?php echo e(route('auth.save')); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="fname" placeholder="Enter first name" value="<?php echo e(old('fname')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="lname" placeholder="Enter last name" value="<?php echo e(old('lname')); ?>">
...
<?php /**PATH C:\xampp\htdocs\BackPage\resources\views/auth/register.blade.php ENDPATH**/ ?>